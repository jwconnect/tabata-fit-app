...
class ExerciseAssets {
  ...
  /// 운동 이름(한글) → 팁 매핑
  static const Map<String, String> _exerciseTips = {
    // 초보자 운동
    '제자리 걷기': '팔을 자연스럽게 흔들며 리듬을 유지하세요',
    '무릎 올리기': '무릎을 배꼽 높이까지 올려주세요',
    '벽 푸시업': '손을 어깨너비로 벌리고 팔꿈치를 45도로 유지하세요',
    '플랭크': '엉덩이가 처지거나 올라가지 않게 일직선을 유지하세요',
    '플랭크 (기본)': '엉덩이가 처지거나 올라가지 않게 일직선을 유지하세요',
    '스쿼트': '무릎이 발끝을 넘지 않게 엉덩이를 뒤로 빼세요',
    '스쿼트 (기본)': '무릎이 발끝을 넘지 않게 엉덩이를 뒤로 빼세요',
    '런지': '앞무릎이 90도가 되도록 깊게 내려가세요',
    '런지 (기본)': '앞무릎이 90도가 되도록 깊게 내려가세요',
    '카프레이즈': '발뒤꿈치를 최대한 높이 들어 종아리를 수축하세요',
    '글루트 브릿지': '엉덩이를 들 때 코어에 힘을 주고 천천히 내려오세요',

    // 중급자 운동
    '점프 스쿼트': '착지할 때 무릎을 부드럽게 굽혀 충격을 흡수하세요',
    '푸시업': '코어에 힘을 주고 몸을 일직선으로 유지하세요',
    '플랭크 잭': '점프할 때 엉덩이가 위아래로 흔들리지 않게 하세요',
    '하이니': '팔을 힘차게 흔들며 무릎을 가슴 쪽으로 당기세요',
    '하이니 (High Knees)': '팔을 힘차게 흔들며 무릎을 가슴 쪽으로 당기세요',
    '점핑잭': '착지할 때 무릎을 살짝 굽혀 관절을 보호하세요',
    '마운틴 클라이머': '엉덩이를 낮게 유지하고 빠르게 무릎을 당기세요',
    '크런치': '목에 힘을 빼고 복부의 힘으로만 상체를 들어올리세요',
    '레그레이즈': '허리가 바닥에서 뜨지 않게 복부에 힘을 유지하세요',
    '러시안 트위스트': '등을 45도로 기울이고 복부의 회전을 느끼세요',

    // 고급자 운동
    '버피': '점프할 때 팔을 머리 위로 쭉 뻗어 전신을 늘려주세요',
    '점프 런지': '착지할 때 양 무릎이 90도가 되도록 깊게 내려가세요',
    '다이아몬드 푸시업': '손을 다이아몬드 모양으로 모아 삼두근을 집중 자극하세요',
    '터크 점프': '점프 정점에서 무릎을 가슴까지 당겨 최대 수축하세요',
  };

  /// 운동 이름으로 팁 가져오기
  static String? getTipByName(String exerciseName) {
    return _exerciseTips[exerciseName];
  }
}

...
final List<Workout> defaultWorkouts = [
  ...
  Workout(
    id: 'tabata_upper_body',
    name: '상체 강화 타바타',
    description: '팔, 어깨, 가슴 근력 강화를 위한 타바타입니다.',
    difficulty: 'INTERMEDIATE',
    muscleGroups: ['상체', '팔', '어깨'],
    instructions: ['푸시업', '벽 푸시업', '플랭크', '마운틴 클라이머'],
    tips: ['팔꿈치 각도를 45도로 유지하세요.', '코어에 힘을 주세요.'],
  ),
  ...
  Workout(
    id: 'tabata_hiit',
    name: 'HIIT 타바타',
    description: '폭발적인 고강도 인터벌로 최대 칼로리 소모!',
    difficulty: 'ADVANCED',
    muscleGroups: ['심폐', '전신'],
    instructions: ['버피', '터크 점프', '마운틴 클라이머', '점프 스쿼트'],
    tips: ['각 동작을 최대 강도로 수행하세요.', '휴식 시간을 최대한 활용하세요.'],
  ),
];
